...
//CODE HERE
  const fidoSpeak = bark.call(fido, this.name);
...
//CODE HERE
  let phone1 = new Phone('string', 'string', 1, 'string', false);
  
  let phone2 = new Phone('string', 'string', 1, 'string', false);
  
  let phone3 = new Phone('string', 'string', 1, 'string', false);
